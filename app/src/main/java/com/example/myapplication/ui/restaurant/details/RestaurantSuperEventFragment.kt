 ...
 * Use the [RestaurantSuperEventFragment.newInstance] factory method to
...
class RestaurantSuperEventFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RestaurantSuperEventFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RestaurantSuperEventFragment().apply {
