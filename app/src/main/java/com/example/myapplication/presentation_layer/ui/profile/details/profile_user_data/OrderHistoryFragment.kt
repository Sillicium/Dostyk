package com.example.myapplication.presentation_layer.ui.profile.details.profile_user_data
...
class OrderHistoryFragment : BindingFragment<FragmentOrderHistoryBinding>(
    ...
    private fun setupView(){
        ...
        val historyAdapter = PaymentHistoryAdapter(requireContext()).apply {
            setItems(listOf(com.example.myapplication.presentation_layer.ui.history.HistoryPageFragment().threeElement) )
        }
